...
function datCo(){
	...
	// Quân đỏ
	for(var i = 1; i < 9; i++){
		document.getElementById("i2" + i).src = CoTrang.Tot;
	}
	document.getElementById("i11").src = CoTrang.Xe;
	document.getElementById("i12").src = CoTrang.Ma;
	document.getElementById("i13").src = CoTrang.Tuong;
	document.getElementById("i14").src = CoTrang.Hau;
	document.getElementById("i15").src = CoTrang.Vua;
	document.getElementById("i16").src = CoTrang.Tuong;
	document.getElementById("i17").src = CoTrang.Ma;
	document.getElementById("i18").src = CoTrang.Xe;
}
